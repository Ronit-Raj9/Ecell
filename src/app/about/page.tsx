        ...
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-medium text-primary mb-3">Incubation Support</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  We help startups with mentorship, resources, and networking opportunities to grow their ventures.
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-medium text-primary mb-3">Funding Assistance</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  We connect promising startups with potential investors and help them secure funding.
                </p>
              </div>
            </div>
          </section>
