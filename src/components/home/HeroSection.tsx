    ...
    <div className="relative bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              <span className="text-primary">Empowering</span> Students, <br />
              <span className="text-primary">Building</span> Community
            </h1>
              ...
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-primary to-accent rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="text-white text-center">
                    ...
                    <p className="mb-6">Web Development Workshop - May 15, 2024</p>
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center max-w-2xl mx-auto"
        >
